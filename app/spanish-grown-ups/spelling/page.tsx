...
export default function SpellingPage() {
  ...
  const rules = (
    <div className="space-y-3">
      <p className="text-sm text-zinc-600 sm:text-base dark:text-zinc-300">
        ...
        <strong>three rules tell you which</strong> — the accent mark isn&apos;t
        decoration, it&apos;s the third rule. Tap any word to hear where the
        stress lands.
      </p>
  ...
  const pairs = (
    <div>
      <p className="mb-3 text-sm text-zinc-500">
        These pairs sound the same — the accent mark is what tells the reader
        which word you mean.
      </p>
  ...
  const punctuation = (
    <div className="rounded-xl bg-white p-4 shadow-sm dark:bg-zinc-900">
      <p className="text-sm text-zinc-600 dark:text-zinc-300">
        ...
        doesn&apos;t change for a question, the opening mark is the only early
  ...
  const stressQuiz = (
    <div className="rounded-2xl border-2 border-emerald-200 bg-white p-4 sm:p-6 dark:border-emerald-900 dark:bg-zinc-900">
      <p className="text-sm text-zinc-500">
        Listen to a word and tap the syllable that carries the stress. Hearing
  ...
  return (
    <Panes
      title="✍️ Accents & Spelling"
      accent="emerald"
      panes={[
        { id: "rules", label: "Stress rules", content: rules },
        { id: "pairs", label: "One mark, another word", content: pairs },
        { id: "punctuation", label: "¿ ¡", content: punctuation },
        {
          id: "quiz",
          label: "Find the stress",
          icon: "🎧",
          content: stressQuiz,
        },
      ]}
