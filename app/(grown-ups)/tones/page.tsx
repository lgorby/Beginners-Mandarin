...
export default function TonesPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-10">
      <div>
        <h1 className="text-3xl font-bold">🎵 The Four Tones</h1>
        <p className="mt-2 text-zinc-600 dark:text-zinc-300">
          In Mandarin, <strong>the pitch of your voice changes the meaning of
          a word</strong>. The same syllable &ldquo;ma&rdquo; can mean{" "}
          <em>mom</em>, <em>hemp</em>, <em>horse</em>, or <em>to scold</em> —
          depending only on the tone. This is the single most important thing
          to learn first. Tap each card to hear the difference.
        </p>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-5">
        {MA.map((m) => (
          ...
          >
            ...
            <div className="mt-1 text-4xl" lang="zh-CN">
              {m.zh}
            </div>
            <div
      ...
      <div className="rounded-2xl border-2 border-red-200 bg-white p-6 dark:border-red-900 dark:bg-zinc-900">
